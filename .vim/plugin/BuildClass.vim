...
function! s:BuildClass()
  ...
  call add(l:lines, '}')
  call add(l:lines, '')
  call add(l:lines, l:name.'::'.l:name.'(const '.l:name.' &rhs) {')
  call add(l:lines, '    std::cout << "Copy '.l:name.' constructor" << std::endl;')
  call add(l:lines, '    this = &rhs;')
  call add(l:lines, '}')
  call add(l:lines, '')
  call add(l:lines, l:name.'::~'.l:name.'(void) {')
  ...
  call add(l:lines, '}')
  call add(l:lines, '')
  call add(l:lines, l:name.'    &'.l:name.'::operator=(const '.l:name.' &rhs) {')
  call add(l:lines, '    std::cout << "'.l:name.' assignation operator" << std::endl;')
  call add(l:lines, '    if (this != &rhs) {')
